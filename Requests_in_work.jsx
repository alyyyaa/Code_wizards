...
function PersonalAccount() {
    const data = [
        { id: 1, date: '21.03.2024', name: 'Аноним', topic: 'Уборка', category: 'Уборка', action: 'Просмотр' },
    ...
    const columns = [
        ...
        { name: <span className="custom-table-header">Категория</span>, selector: 'category', cell: row => <span className="custom-name-cell">{row.category}</span> },
